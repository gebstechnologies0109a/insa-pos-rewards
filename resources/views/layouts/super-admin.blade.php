...
<html>
<head>
    <title>{{ $brandName }} — Super Admin</title>
    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-60 bg-indigo-950 text-indigo-200 flex flex-col flex-shrink-0">
            <div class="p-5 border-b border-indigo-800">
                <a href="{{ route('super-admin.dashboard') }}" class="text-white font-bold text-lg">{{ $brandName }}</a>
            ...
            <nav class="flex-1 py-4 text-sm space-y-1">
                ...
                <a href="{{ route('super-admin.sessions.index') }}" class="block px-5 py-2.5 hover:bg-indigo-900 hover:text-white transition {{ request()->routeIs('super-admin.sessions.*') ? 'bg-indigo-900 text-white' : '' }}">
                    <span class="flex items-center gap-2">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path></svg>
                        POS Sessions
                    </span>
